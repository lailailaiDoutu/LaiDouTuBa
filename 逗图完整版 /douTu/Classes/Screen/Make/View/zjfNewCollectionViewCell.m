...
@implementation zjfNewCollectionViewCell
-(void)setNewzjfModel:(zjfNewModel *)newzjfModel{
    _newzjfModel = newzjfModel;
        _showLabel.text = newzjfModel.name;
    ...
    //_showLabel.transform = CGAffineTransformMakeRotation(0.1);
          [_itemBackImageView sd_setImageWithURL:[NSURL URLWithString:newzjfModel.picPath]];
