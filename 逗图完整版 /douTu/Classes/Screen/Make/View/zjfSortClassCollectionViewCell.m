//
//  zjfSortClassCollectionViewCell.m
//  斗图APP
//
...
@implementation zjfSortClassCollectionViewCell

- (void)setSortModel:(zjfSortModel *)sortModel{
    if(_sortModel != sortModel){
        
        _showLabel.text = sortModel.name;
        ...
        [_itemBackImageView sd_setImageWithURL:[NSURL URLWithString:sortModel.picPath]];
