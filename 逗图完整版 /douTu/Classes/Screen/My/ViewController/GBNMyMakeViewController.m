...
@interface GBNMyMakeViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation GBNMyMakeViewController
-(void)viewWillAppear:(BOOL)animated{
    ...
    [button sizeToFit];
    [button addTarget:self action:@selector(deleteItem2) forControlEvents:UIControlEventTouchUpInside];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"我制作的";
